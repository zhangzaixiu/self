    ...
    CityPicker.prototype = {
        ...
        render: function () {
            var p = this.getPosition(),
                ...
                dropdown = '<div class="city-picker-dropdown" style="left:0px;top:100%; width:518px;">' +
                    '<div class="city-select-wrap">' +
                    '<div class="city-select-tab">' +
                    '<a class="active" data-count="province">省份</a>' +
                    (this.includeDem('city') ? '<a data-count="city">城市</a>' : '') +
                    (this.includeDem('district') ? '<a data-count="district">区县</a>' : '') + '<a style="float:right" class="clickClose">确认</a></div>' +
        ...
        bind: function () {
                ...
                if ($active.data('code') !== $(this).data('code')) {
                    ...
                    if (last) {
                        if (typeof(eval("initDistinct")) == "function") {
                            initDistinct($(this).data('code'),$(this).attr('title'));
                        }  
                        //console.log($this)
                        $this.close();
                    }
            ...
            $('body').on('click','.clickClose',function(){
                $this.close();
            })
            if (this.$province) {
