    ...
    CityPicker.prototype = {
        ...
        render: function () {
            var p = this.getPosition(),
                ...
                dropdown = '<div class="city-picker-dropdown" style="left:0px;top:100%;">' +
                    ...
                    '<a id="city_reset" style="float:right;">重置</a>'+
        ...
        feedText: function () {
            ...
            if (text) {
                ...
                var last =  this.$textspan.find('>.title span:last'),code = last.data('code')+'',count = last.data('count'),final = '';
                if(count == 'province'){
                    final = code.substr(0,2);
                }else if(count == 'district'){
                    final = code;
                }else  if(count == 'city')
                    if(code.substr(4,2) =='00'){
                        final = code.substr(0,4);
                    }else{
                        final = code;
                    }
                if (typeof(eval("initDistinct")) == "function") {
